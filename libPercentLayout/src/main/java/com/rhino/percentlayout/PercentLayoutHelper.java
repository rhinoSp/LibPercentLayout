 ...
 * {@link com.rhino.percentlayout.PercentLayoutHelper.PercentLayoutParams}.
 ...
 * method that you implemented for {@link com.rhino.percentlayout.PercentLayoutHelper.PercentLayoutParams} interface.
 * <li> Override
...
public class PercentLayoutHelper {
    ...
    private static int layout_marginRightPercent = R.styleable.PercentLayout_Layout_layout_marginRightPercent;
    private static int layout_marginBottomPercent = R.styleable.PercentLayout_Layout_layout_marginBottomPercent;
    private static int layout_marginStartPercent = R.styleable.PercentLayout_Layout_layout_marginStartPercent;
    private static int layout_marginEndPercent = R.styleable.PercentLayout_Layout_layout_marginEndPercent;
    private static int layout_textSizePercent = R.styleable.PercentLayout_Layout_layout_textSizePercent;
    private static int layout_maxWidthPercent = R.styleable.PercentLayout_Layout_layout_maxWidthPercent;
    private static int layout_maxHeightPercent = R.styleable.PercentLayout_Layout_layout_maxHeightPercent;
    private static int layout_minWidthPercent = R.styleable.PercentLayout_Layout_layout_minWidthPercent;
    private static int layout_minHeightPercent = R.styleable.PercentLayout_Layout_layout_minHeightPercent;
    private static int layout_paddingPercent = R.styleable.PercentLayout_Layout_layout_paddingPercent;
    private static int layout_paddingTopPercent = R.styleable.PercentLayout_Layout_layout_paddingTopPercent;
    private static int layout_paddingBottomPercent = R.styleable.PercentLayout_Layout_layout_paddingBottomPercent;
    private static int layout_paddingLeftPercent = R.styleable.PercentLayout_Layout_layout_paddingLeftPercent;
    private static int layout_paddingRightPercent = R.styleable.PercentLayout_Layout_layout_paddingRightPercent;
    ...
    public static PercentLayoutInfo setWidthAndHeightVal(TypedArray array, PercentLayoutInfo info) {
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array, layout_widthPercent, true);
        if (percentVal != null) {
        ...
        percentVal = getPercentVal(array, layout_heightPercent, false);
    ...
    public static PercentLayoutInfo setTextSizeSupportVal(TypedArray array, PercentLayoutInfo info) {
        //textSizePercent 默认以高度作为基准
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array, layout_textSizePercent, false);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
    ...
    public static PercentLayoutInfo setMinMaxWidthHeightRelatedVal(TypedArray array, PercentLayoutInfo info) {
        //maxWidth
    ...
    public static PercentLayoutInfo setMarginRelatedVal(TypedArray array, PercentLayoutInfo info) {
        //默认margin参考宽度
        ...
        percentVal = getPercentVal(array, layout_marginLeftPercent, true);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        percentVal = getPercentVal(array, layout_marginTopPercent, false);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        percentVal = getPercentVal(array, layout_marginRightPercent, true);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        percentVal = getPercentVal(array, layout_marginBottomPercent, false);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        percentVal = getPercentVal(array, layout_marginStartPercent, true);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        percentVal = getPercentVal(array, layout_marginEndPercent, true);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
     ...
     * @param info
     */
    public static PercentLayoutInfo setPaddingRelatedVal(TypedArray array, PercentLayoutInfo info) {
        //默认padding以宽度为标准
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array,
    ...
    public static PercentLayoutInfo.PercentVal getPercentVal(TypedArray array, int index, boolean baseWidth) {
